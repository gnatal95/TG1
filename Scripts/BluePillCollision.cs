...
public class BluePillCollision : MonoBehaviour {
    ...
    void Start()
    {
		//carrega assests de explosao e de som
    ...
    void OnTriggerEnter(Collider collider)
    {
		...
		//quaternion.identity retorna a rotacao do objeto
        var rotation = Quaternion.identity;

		//a funcao instantiate retorna um clone do objeto que esta sendo usado com argumento
